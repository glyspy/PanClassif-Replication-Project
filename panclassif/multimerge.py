def mtrain(names, homepath):
    ...
    cresult.to_csv(homepath + '/train_data/mul_Cancer.txt.bz2', compression="bz2", sep='\t', header=None, index=None, index_label=None)
    nresult.to_csv(homepath + '/train_data/mul_Normal.txt.bz2', compression="bz2", sep='\t', header=None, index=None, index_label=None)
...
def mtest(names, homepath):
    ...
    # Merging all the cancer and normal data together and saving them
    cresult.to_csv(homepath + '/test_data/mul_Cancer.txt.bz2', compression="bz2", sep='\t', header=None, index=None, index_label=None)
    nresult.to_csv(homepath + '/test_data/mul_Normal.txt.bz2', compression="bz2", sep='\t', header=None, index=None, index_label=None)
